...
if start=="y":
    ...
    startWeapon=("")
    while startWeapon=="":
        startWeapon=input("What weapon would you like to bring with you on your hunting trip? \nA: A Bow \nB: A Dagger \nAnswer: ")
    ...
    if boarDead==True:
        ...
        while scavengeBoar=="":
            ...
            if scavengeBoar=="A":
                ...
                scavangeBoar==""
    #After boar death, come across village named Vale
    if boarend==1:
        ...
        if life==1:
            ...
            while statCheck=="":
                ...
                if statCheck=="y":
                    ...
                    print("""
--------------------------Stats--------------------------
Total Skill Level:""", totalsSkillLevel, """
        HP:""",PmaxHP, """ / """ PcurrentHP
    Skill Breakdown:
